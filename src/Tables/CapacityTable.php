...
/**
 * Total data-codeword capacity per (version, ECC level).
...
final class CapacityTable
{
    ...
    public static function dataCodewords(int $version, EccLevel $ecc): int
    {
        if ($version < 1 || $version > 40) {
            throw new InvalidArgumentException("Version must be in 1..40, got {$version}");
        }

        return self::TABLE[$version][$ecc->value];
    }

    public static function dataCapacityBits(int $version, EccLevel $ecc): int
    {
